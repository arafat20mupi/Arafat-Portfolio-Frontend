          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Controller
                ...
                control={control}
                rules={{ required: true }}
                render={({ field }) => <ReactQuill value={field.value || ""} onChange={field.onChange} />}
              />
            </div>
            <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div><Label>Duration</Label><Input {...register("duration")} /></div>
              <div><Label>Team</Label><Input {...register("team")} /></div>
              <div><Label>Year</Label><Input {...register("year")} /></div>
            </div>
            <div>
